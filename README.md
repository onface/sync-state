...
<div class="face-one-intro">
    ...
    <div class="face-one-intro-tool">
        ...
        <!-- MARKRUN-HTML
            ...
            <a href="http://github.com/onface/sync-state" class="face-one-intro-btn">GITHUB</a>
        -->
    </div>
</div>
        ...
        <tr>
            <td align="center" >
                <div class="face-one-feature-item">
                    ...
                    <div class="face-one-feature-item-desc">通过<code>{...props}</code>实现同步数据</div>
                </div>
            </td>
            <td align="center" >
                <div class="face-one-feature-item">
                    ...
                    <br />
                    <div class="face-one-feature-item-label">快速上手</div>
                    <div class="face-one-feature-item-desc">接口简单，一看就懂</div>
                </div>
            </td>
            <td align="center" >
                <div class="face-one-feature-item">
                    ...
                    <br />
                    <div class="face-one-feature-item-label">场景明确</div>
                    <div class="face-one-feature-item-desc"><code>defaultValue</code>的替代品</div>
                </div>
            </td>
        </tr>
    </table>
